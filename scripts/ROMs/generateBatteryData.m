...
%h_vec = [0 0.5 1 2 5 10 15 100];
h_vec = logspace(0,2,8);
%h_vec = 0:2:14;
h_vec(1) = 0.001;
p=length(h_vec);
...
for i=1:length(h_vec)
    ...
    figfilename = strcat('BatteryMode_h', num2str( round(h_vec(i),0) ), '.png' );
    exportgraphics(gcf,figfilename,'Resolution',300)
end
%save BatteryData_ModesResults.mat model h_vec modes_matrix lambdas fixed_points Tambient boundaryIDs